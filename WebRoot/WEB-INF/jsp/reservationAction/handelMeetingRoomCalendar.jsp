...
<script src='${pageContext.request.contextPath}/script/fullcalendar/handelMeetingRoomFullcalendarConfig.js'></script>
  </head>
  ...
  /**
	...
	$(document).ready(function(){
			...
			$('div#meetRoom span').click(function(){
				...
				$.ajax({
					type:'post',
					url:rootPath + '/calendarReservation_toShowHandel.action',
					cache:false,
